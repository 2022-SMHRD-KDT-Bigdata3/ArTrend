					...
					<div class="profile">
						...
						<div class="info">
							<div class="username">
								...
								<!-- if( 구독자정보 == null) 구독하기 버튼 -->
							
								    <button id="subscrib_btn" onclick = "location.href='SubscribeService?gallery_user_email=<%=user_email_header%>'"><span>구독취소</span></button>
                                    <button id="msg_btn" onclick = "location.href = 'MessageSystem.jsp'"><span>메세지</span></button>
					
								<!-- else(구독자정보가 != null) 구독취소 /메세지 -->
